...
Record.create(domain_id: 1, name: 'bulutfon.net', rtype: '3', content: 'dns1-dnz1.bulutfon.net', ttl: '600', prio: '0')
Record.create(domain_id: 1, name: 'bulutfon.net', rtype: '3', content: 'dns1-dnz2.bulutfon.net', ttl: '600', prio: '0')
